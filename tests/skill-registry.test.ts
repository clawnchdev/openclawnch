 ...
 *   10. Plugin registers 111 commands (including skills, interrupt, api, pull, delegate, policymode, profile)
 */
...
describe('Plugin Registration — Skills', () => {
   it('registers 111 commands including /skills, /interrupt, /api, and /pull', { timeout: 15000 }, async () => {
