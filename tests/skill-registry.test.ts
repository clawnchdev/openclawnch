 ...
 *   10. Plugin registers 112 commands (including skills, interrupt, api, pull, delegate, policymode, profile, upgrade)
 */
...
describe('Plugin Registration — Skills', () => {
   it('registers 112 commands including /skills, /interrupt, /api, and /pull', { timeout: 15000 }, async () => {
