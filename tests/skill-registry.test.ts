 ...
 *   10. Plugin registers 109 commands (including skills, interrupt, api, pull, delegate)
 */
...
describe('Plugin Registration — Skills', () => {
   it('registers 109 commands including /skills, /interrupt, /api, and /pull', { timeout: 15000 }, async () => {
