 ...
 *   10. Plugin registers 117 commands (including skills, interrupt, api, pull, delegate, policymode, profile, upgrade)
 */
...
describe('Plugin Registration — Skills', () => {
   it('registers 117 commands including /skills, /interrupt, /api, and /pull', { timeout: 15000 }, async () => {
