 ...
 *   9.  Plugin registers 45 tools and 114 commands (V6: +1 tool, +1 command; V7: +3 commands)
...
describe('V6 Plugin Registration', () => {
  ...
  it('registers 114 commands including /policies, /delegate, /policymode, /profile, and /upgrade', { timeout: 15000 }, async () => {
    const commands: any[] = [];
    const mockApi = {
      registerTool: () => {},
    ...
    expect(commands.find(c => c.name === 'profile')).toBeDefined();
  });
});
