 ...
 * - Plugin registration counts (45 tools, 109 commands, 39 tool configs)
 */
...
describe('V5 Plugin Registration', () => {
  ...
  it('plugin registers 109 commands including agents, webhooks, skills, interrupt, api, and pull', { timeout: 15000 }, async () => {
    const plugin = (await import('../extensions/crypto/index.js')).default;
