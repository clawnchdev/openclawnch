 ...
 * - Plugin registration counts (44 tools, 104 commands, 38 tool configs)
 */
...
describe('V5 Plugin Registration', () => {
  ...
  it('plugin registers 104 commands including agents, webhooks, skills, interrupt, and api', { timeout: 15000 }, async () => {
    const plugin = (await import('../extensions/crypto/index.js')).default;
