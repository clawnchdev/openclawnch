 ...
 *   8.  Plugin registers 114 commands including /delegate, /policymode, /profile, /upgrade
...
describe('V7 Plugin Registration', () => {
  it('plugin registers 114 commands including /delegate, /policymode, /profile, and /upgrade', { timeout: 15000 }, async () => {
    const commands: any[] = [];
    const mockApi = {
      registerTool: () => {},
...
describe('/upgrade Command', () => {
  ...
  it('plugin registers /upgrade command (114 commands)', async () => {
    const commands: any[] = [];
    const api = {
      registerTool: () => {},
      registerCommand: (c: any) => commands.push(c),
